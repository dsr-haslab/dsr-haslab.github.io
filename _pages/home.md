...
Distributed storage research at the [HASLab](http://www.haslab.uminho.pt) is motivated by the observation that storage systems are a cornerstone component for a wide range of research and industrial areas such as, cloud computing, internet-of-things, databases, machine learning/artificial inteligence, etc. Moreover, our research is driven by the need of such systems to provide efficient, scalable, resilient and secure solutions that can adapt to the exponentialy increase of digital information and to the different needs of very heterogeneous applications and infrastructures. 
